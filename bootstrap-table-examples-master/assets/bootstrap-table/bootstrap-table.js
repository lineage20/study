...
(function ($) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $.each(this.options.columns, function (i, columns) {
            ...
            $.each(columns, function (j, column) {
                ...
                html.push(sprintf('<div class="th-inner %s" lang="' + column.lang + '">', that.options.sortable && column.sortable ?
                    'sortable both' : ''));
    ...
    BootstrapTable.prototype.initServer = function (silent, query, url) {
        var that = this,
            data = {};
            var params = {
                searchText: $("#searchForm").serialize(),
        ...
        if (this.options.ajax) {
            ...
            $.extend(request.data, $("#searchForm").serializeObject());
